...
def deep_node_recom():
    ...
    for i in range(now_phase + 1):
        click_train = pd.read_csv(user_data + 'underexpose_train/underexpose_train_click-{}.csv'.format(i), header=None,
                                  names=['user_id', 'item_id', 'time'])
        click_test = pd.read_csv(user_data + 'underexpose_test/underexpose_test_click-{}.csv'.format(i), header=None,
                                 names=['user_id', 'item_id', 'time'])
        qtime_test = pd.read_csv(user_data + 'underexpose_test/underexpose_test_qtime-{}.csv'.format(i), header=None,
                                 names=['user_id', 'time'])
        click_train["time"] += i
        click_test["time"] += i
        qtime_test["time"] += i
